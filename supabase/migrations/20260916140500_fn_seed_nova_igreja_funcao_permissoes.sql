-- fn_seed_nova_igreja precisa nascer já com as permissões e as duas novas
-- funções do Ensino (Auxiliar, Secretaria), senão toda igreja nova ficaria
-- sem elas até alguém rodar a migration anterior manualmente de novo.
-- Único trecho alterado: o INSERT em ministerio_funcoes ganhou a coluna
-- permissoes e as linhas de Auxiliar/Secretaria — todo o resto da função é
-- idêntico ao definido antes desta migration.
...
BEGIN
  ...
  INSERT INTO ministerio_funcoes (nome, ministerio_id, church_id, permissoes, descricao) VALUES
    ...
    ('Líder de Louvor',           v_ministerio_musica_id,     p_church_id, '{}', null),
    ('Pregador(a)',                v_ministerio_celebracao_id, p_church_id, '{}', null),
    ('Orador(a) de Abertura',     v_ministerio_celebracao_id, p_church_id, '{}', null),
    ('Responsável pelos Avisos',  v_ministerio_celebracao_id, p_church_id, '{}', null),
    ('Professor(a)',               v_ministerio_kids_id,       p_church_id, '{}', null),
    ('Responsável pelo Check-in', v_ministerio_kids_id,       p_church_id, '{}', null),
    ('Fotógrafo(a)',               v_ministerio_midia_id,      p_church_id, '{}', null),
    ('Cinegrafista',               v_ministerio_midia_id,      p_church_id, '{}', null),
    ('Projecionista',              v_ministerio_midia_id,      p_church_id, '{}', null),
