        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="nome">Nome {origem === 'publica' ? '(opcional)' : ''}</Label>
                  <Input
                    id="nome"
                    type="text"
                    ...
                    disabled={origem === 'app' && !!profileNome}
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="email">E-mail {origem === 'publica' ? '(opcional)' : ''}</Label>
                  <Input
                    id="email"
                    type="email"
                    ...
                    disabled={origem === 'app' && !!profileEmail}
                  />
                </div>
              </div>
