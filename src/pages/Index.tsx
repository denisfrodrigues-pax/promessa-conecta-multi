...
const INSTAGRAM_URL = "https://instagram.com/promessahortolandia";
const MAPS_EMBED_FIXO = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3675.7!2d-47.21!3d-22.87!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjLCsDUyJzEyLjAiUyA0N8KwMTInMzYuMCJX!5e0!3m2!1spt-BR!2sbr!4v1";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-card rounded-2xl p-8 text-center border border-border shadow-soft hover:shadow-elevated transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-promessa-600 font-semibold text-lg">{HORARIOS_FIXOS.ebd}</p>
            </div>
            <div className="bg-card rounded-2xl p-8 text-center border border-border shadow-soft hover:shadow-elevated transition-all duration-300 hover:-translate-y-1">
              <div className="w-14 h-14 rounded-full bg-promessa-100 flex items-center justify-center mx-auto mb-4">
                <Clock className="w-7 h-7 text-promessa-600" />
              ...
              <p className="text-promessa-600 font-semibold text-lg">{HORARIOS_FIXOS.culto}</p>
            </div>
            <div className="bg-card rounded-2xl p-8 text-center border border-border shadow-soft hover:shadow-elevated transition-all duration-300 hover:-translate-y-1">
              <div className="w-14 h-14 rounded-full bg-promessa-100 flex items-center justify-center mx-auto mb-4">
            ...
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <div className="flex items-start gap-3">
                  ...
                  <p className="whitespace-pre-line">{ENDERECO_FIXO}</p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p>Sábados às {HORARIOS_FIXOS.ebd} (Escola Bíblica) e {HORARIOS_FIXOS.culto} (Culto)</p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex gap-3 mt-4">
                <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>Sábado {HORARIOS_FIXOS.ebd} - Escola Bíblica</li>
                <li>Sábado {HORARIOS_FIXOS.culto} - Culto de Celebração</li>
