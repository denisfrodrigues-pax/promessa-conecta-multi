            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {hubCards.map((card, index) => (
                <Link
                  key={index}
                  to={card.link}
                  className="bg-muted/30 rounded-2xl p-6 shadow-sm border border-border/50 hover:shadow-lg hover:border-promessa-200 transition-all duration-300 group"
                >
              ...
              {/* Trilha Amar e Servir - Destaque Visual */}
              <Link
