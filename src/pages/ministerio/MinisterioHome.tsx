  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Selecione um módulo para continuar.</p>
      </div>
          ...
          >
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                {mod.descricao && <p className="text-sm text-muted-foreground truncate">{mod.descricao}</p>}
              </div>
